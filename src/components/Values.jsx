...
export default function Values() {
  ...
  return (
    <section id="craft" className="py-20 md:py-28 bg-[#140C07] text-[#FAF7F2] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <Reveal effect="up" className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="font-sans text-base text-[#D4C7BC] leading-relaxed font-light">
            ...
            return (
              ...
              >
                <SpotlightCard
                  ...
                  className="h-full bg-[#1F140D] rounded-2xl p-8 border border-[#B88B58]/25 shadow-xl hover:-translate-y-2 hover:shadow-[0_22px_45px_-10px_rgba(184,139,88,0.2)] transition-all duration-500 ease-out group flex flex-col justify-between"
                >
                  <div>
                    <div className="w-13 h-13 rounded-xl bg-[#2A1C14] border border-[#B88B58]/30 group-hover:bg-[#B88B58] group-hover:border-[#B88B58] flex items-center justify-center mb-6 transition-all duration-500">
                      <Icon className="w-6 h-6 text-[#B88B58] group-hover:text-[#140C07] transition-colors duration-300" />
                    </div>
